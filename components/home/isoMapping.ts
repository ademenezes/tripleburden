// ISO 3166-1 numeric → alpha-3. Built to join world-atlas TopoJSON features
// (keyed by numeric id) to our countries.json rows (keyed by iso3).
// Covers all UN member states + most dependencies present in world-atlas 110m.
export const NUMERIC_TO_ISO3: Record<string, string> = {
  ...
  // Some world-atlas features include unrecognised entities — map what we can
  '-99': 'XXX',
};

export function numericToIso3(id: string | number | undefined): string | null {
